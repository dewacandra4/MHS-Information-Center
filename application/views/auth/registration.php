          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <form class="user" method="post" action="<?= base_url('auth/registration');?>">
                ...
                <div class="form-group">
                  <input placeholder="Enter monthly income" type="number" id="monthlyIncome" name="monthlyIncome" class="form-control pt-1 pb-1"  style="border-radius: 18px;" value="<?=set_value('monthlyIncome');?>">
